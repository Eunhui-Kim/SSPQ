...
def eval_classification(model, sessinit, dataflow):
    ...
    for _ in tqdm.trange(dataflow.size()):
        ...
        #acc1_duration = time.time() - start_time1 
        #start_time2 = time.time()
        #acc5.feed(top5.sum(), batch_size)
        #acc5_duration = time.time() - start_time2
    duration = time.time() - start_time1
    logger.info("Top1 Error: {}, duration: {}".format(acc1.ratio, duration/60))
    #print("Top5 Error: {}, duration: {}".format(acc5.ratio, acc5_duration))
