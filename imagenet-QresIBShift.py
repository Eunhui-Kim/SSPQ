...
from resnet_model2 import preact_group, resnet_backbone, resnet_group, asl_group, resIBShift_group, QresIBShift_group 


class Model(ImageNetModel):
    def __init__(self, depth, mode='QresIBShift'):
        self.mode = mode
        basicblock = getattr(resnet_model2, mode + '_basicblock', None)
        bottleneck = getattr(resnet_model2, mode + '_bottleneck', None)
        self.group = getattr(resnet_model2, mode + '_group', None)
